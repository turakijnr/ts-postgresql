...
var post_controller_1 = require("../controller/post.controller"); // import the post controller
var Server = /** @class */ (function () {
    function Server() {
        this.app = (0, express_1.default)();
        this.configuration();
        this.postcontroller = new post_controller_1.PostController(); // create a new controller instance
        this.routes();
    }
    /**
